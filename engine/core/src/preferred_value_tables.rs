pub const E3_BASE: &[f64] = &[1.0, 2.2, 4.7];

pub const E6_BASE: &[f64] = &[1.0, 1.5, 2.2, 3.3, 4.7, 6.8];

pub const E12_BASE: &[f64] = &[1.0, 1.2, 1.5, 1.8, 2.2, 2.7, 3.3, 3.9, 4.7, 5.6, 6.8, 8.2];

pub const E24_BASE: &[f64] = &[
    1.0, 1.1, 1.2, 1.3, 1.5, 1.6, 1.8, 2.0, 2.2, 2.4, 2.7, 3.0, 3.3, 3.6, 3.9, 4.3, 4.7, 5.1, 5.6,
    6.2, 6.8, 7.5, 8.2, 9.1,
];

pub const E48_BASE: &[f64] = &[
